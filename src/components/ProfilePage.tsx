...
export function ProfilePage({ onSelect }: ProfilePageProps) {
  ...
  const stats = useMemo(() => {
    const displayPortfolio = portfolio.length > 0 ? portfolio : SAMPLE_DATA;
...
const SAMPLE_DATA: PortfolioItem[] = [
  {
    id: 'sample-1',
    buildingId: '1',
    propertyName: '1400 S Wabash Ave',
    address: '1400 S Wabash Ave, Chicago, IL',
    addedAt: new Date(),
    energyScore: 45,
    type: 'Multifamily',
    sqft: '120500',
    ...
    longitude: '-87.6258',
    financials: {
      savingsPotential: 84500,
      totalAnnualCost: 450000
    }
  },
  {
    id: 'sample-2',
    buildingId: '2',
    propertyName: '200 E Randolph St',
    ...
    longitude: '-87.6214',
    financials: {
      savingsPotential: 41200,
      totalAnnualCost: 890000
    }
  },
  {
    id: 'sample-3',
    buildingId: '3',
    propertyName: '100 W Monroe St',
    ...
    longitude: '-87.6312',
    financials: {
      savingsPotential: 112000,
      totalAnnualCost: 320000
    }
  }
];
